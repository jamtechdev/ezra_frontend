...
export default function Home() {
  ...
  const [providerStatus, setProviderStatus] = useState({ state: 'idle', message: '' });
  ...
  const categories = [
    ...
    { icon: '🔧', name: 'Assembly', desc: 'Furniture & equipment setup', to: '/assembly' },
    ...
    { icon: '⚡', name: 'Electrical', desc: 'Fixtures\n& troubleshooting', to: '/electrician' },
  ...
  const handleSubmitHelp = async (e) => {
    ...
    try {
      ...
      setHelpStatus({ state: 'success', message: 'Thanks! An Ezra will reach out shortly.' });
      setHelpForm({ name: '', email: '', phone: '', details: '' });
    } catch (error) {
      setHelpStatus({
        state: 'error',
        message: 'We could not send your request. Please try again or email Ezrainisrael1@gmail.com.',
      });
    }
  };
  ...
  const handleSubmitProvider = async (e) => {
    e.preventDefault();
    setProviderStatus({ state: 'loading', message: 'Submitting your interest...' });
    try {
      ...
      setProviderStatus({ state: 'success', message: 'Thanks! Our team will reach out within 1 business day.' });
      setProviderForm({ name: '', phone: '', email: '', industry: '' });
    } catch (error) {
      setProviderStatus({
        state: 'error',
        message: 'We could not process your request. Please try again or email Ezrainisrael1@gmail.com.',
      });
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#ffffff' }}>
      ...
      <section id="how-it-works" style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 720, margin: '0 auto 48px' }}>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 16, color: 'white' }}>
            How it Works
          </h2>
          <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.92)', lineHeight: 1.7, fontWeight: 500 }}>
        ...
        <div className="footer-grid" style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontSize: 14 }}>
              ...
              <a href="#" style={{ color: '#9ca3af', textDecoration: 'none' }}>Herzliya</a>
              <a href="#" style={{ color: '#9ca3af', textDecoration: 'none' }}>Ra’anana</a>
            </div>
          </div>
          <div>
          ...
          >
            <button
              ...
              style={{
                ...
                height: 36,
                borderRadius: '50%',
                cursor: providerStatus.state === 'loading' ? 'default' : 'pointer',
                fontSize: 18,
                fontWeight: 700,
              }}
            ...
            <h2 id="provider-modal-title" style={{ fontSize: 30, fontWeight: 900, color: '#1f2937', marginBottom: 8 }}>
              Become an EZRA
            </h2>
            <p style={{ color: '#64748b', marginBottom: 28, fontSize: 15, lineHeight: 1.6 }}>
              Tell us about yourself so we can get you verified and earning quickly.
            </p>

            <form onSubmit={handleSubmitProvider} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>Full Name</span>
                <input
                  type="text"
              ...
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>Phone Number</span>
                <input
                  type="tel"
              ...
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>Email Address <span style={{ color: '#94a3b8' }}>(optional)</span></span>
                <input
                  type="email"
              ...
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>Industry</span>
                <input
                  type="text"
                  value={providerForm.industry}
                  onChange={(e) => updateProviderField('industry', e.target.value)}
                  required
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 16,
                  border: 'none',
                  background: providerStatus.state === 'loading'
                ...
                onMouseEnter={(e) => {
                  if (providerStatus.state !== 'loading') {
                    ...
                    e.currentTarget.style.boxShadow = '0 26px 56px rgba(99, 102, 241, 0.45)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (providerStatus.state !== 'loading') {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 20px 48px rgba(99, 102, 241, 0.35)';
                  }
                }}
              >
                {providerStatus.state === 'loading' ? 'Submitting...' : 'Submit application'}
              </button>
                  ...
                  style={{
                    ...
                    background:
                      providerStatus.state === 'success'
                        ...
                        : 'rgba(239, 68, 68, 0.12)',
                    color: providerStatus.state === 'success' ? '#047857' : '#b91c1c',
                    fontSize: 14,
                    fontWeight: 600,
                  }}
                >
      ...
      {showHelpModal && (
        ...
        >
          ...
          >
            ...
            <h2 id="help-modal-title" style={{ fontSize: 30, fontWeight: 900, color: '#1f2937', marginBottom: 8 }}>
              Get help from Ezra
            </h2>
            <p style={{ color: '#64748b', marginBottom: 28, fontSize: 15, lineHeight: 1.6 }}>
              Share a few details and we’ll route your request to our support team instantly.
            </p>

            <form onSubmit={handleSubmitHelp} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>Full Name</span>
                <input
                  type="text"
              ...
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>Email Address</span>
                <input
                  type="email"
              ...
              <label style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span style={{ fontWeight: 700, color: '#1f2937', fontSize: 14 }}>What do you need help with?</span>
                <textarea
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 16,
                  border: 'none',
                  background: helpStatus.state === 'loading'
                ...
                onMouseEnter={(e) => {
                  if (helpStatus.state !== 'loading') {
                    e.currentTarget.style.transform = 'translateY(-2px)';
                    e.currentTarget.style.boxShadow = '0 24px 50px rgba(102, 126, 234, 0.45)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (helpStatus.state !== 'loading') {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 18px 42px rgba(102, 126, 234, 0.35)';
                  }
                }}
              >
                  ...
                  style={{
                    ...
                    background:
                      helpStatus.state === 'success'
                        ? 'rgba(16, 185, 129, 0.12)'
                        : 'rgba(239, 68, 68, 0.12)',
                    color: helpStatus.state === 'success' ? '#047857' : '#b91c1c',
                    fontSize: 14,
                    fontWeight: 600,
                  }}
                >
